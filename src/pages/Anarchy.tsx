  ...
  return (
    <div className="min-h-screen bg-background bg-grid-pattern flex flex-col items-center justify-center p-4">
      <div className="minecraft-border rounded-xl bg-card p-8 md:p-12 card-glow max-w-lg w-full text-center">
        <div className="mb-6">
          <div className="w-20 h-20 mx-auto bg-warning/20 rounded-full flex items-center justify-center mb-4">
            <Flame className="w-10 h-10 text-warning" />
          </div>
          <h1 className="text-3xl font-bold text-foreground mb-2">Anarchy</h1>
        ...
        <p className="text-muted-foreground mb-8">
          We are making it! No rules, no limits - pure chaos awaits on MCNP Network.
        </p>
