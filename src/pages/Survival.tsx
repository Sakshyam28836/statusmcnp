...
import { ArrowLeft, TreePine, Construction } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background bg-grid-pattern flex flex-col items-center justify-center p-4">
      <div className="minecraft-border rounded-xl bg-card p-8 md:p-12 card-glow max-w-lg w-full text-center">
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-2">Survival Mode</h1>
        ...
        <p className="text-muted-foreground mb-8">
          We are making it! Stay tuned for the ultimate survival experience on MCNP Network.
        </p>
